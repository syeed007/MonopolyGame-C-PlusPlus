...
namespace Utility
{
  ...
  /// Do not use this as a base of your street class!!!
   struct Street
   {
  ...
  Street string2Street( std::string streetInfo );
   ...
   /// usage of init file reader. This is not an example of how
   /// the card datatype should be implemented.
   struct Card
   {
     /// An empty card...
  ...
  /// Printing Street datatype on screen
  std::ostream& operator <<( std::ostream& os, 
                           const Utility::Street& tt );
  /// KaupunginAlustus -structin tulostaminen
  std::ostream& operator <<( std::ostream& os, 
